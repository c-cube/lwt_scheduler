...
(* OASIS_START *)
(* DO NOT EDIT (digest: d0a6fe0331f76aaf448f9166a68dd8e6) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("lwt_scheduler", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("lwt_scheduler", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\238\\W\178m&n\18980\001\003\1667F\216";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
