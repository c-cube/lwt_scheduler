...
(* OASIS_START *)
(* DO NOT EDIT (digest: c35e16905b29e147a6c27da5749aa636) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("lwt-scheduler", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("lwt-scheduler", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/lwt-scheduler";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\238\203\151\255\205\207\213$\150l\028d\029WP\215";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
